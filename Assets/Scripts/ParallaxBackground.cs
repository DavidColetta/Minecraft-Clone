...
{
    [SerializeField] Vector2 parallaxEffectMultiplier = Vector2.one;
    [SerializeField] bool infiniteHorizontal = true;
    [SerializeField] bool infiniteVertical = false;
    [SerializeField, Tooltip("Leave Empty to automatically use Main Camera")] Transform cameraTransform;
